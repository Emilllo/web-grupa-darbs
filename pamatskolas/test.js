...
function pressReplacing1(value) {
    var result1 = document.getElementById('result11');
    result1.value = value;
}
function pressReplacing2(value) {
    var result2 = document.getElementById('result21');
    result2.value = value;
}
...
function checkThird() {
    var option1 = document.getElementById("option31").checked;
    var option2 = document.getElementById("option32").checked;
    var option3 = document.getElementById("option33").checked;
    var option4 = document.getElementById("option34").checked;
    var option5 = document.getElementById("option35").checked;
    var option6 = document.getElementById("option36").checked;
    var option7 = document.getElementById("option37").checked;
    var option8 = document.getElementById("option38").checked;
...
function emptyThird() {
    ...
    document.getElementById("option31").checked = false;
    document.getElementById("option32").checked = false;
    document.getElementById("option33").checked = false;
    document.getElementById("option34").checked = false;
    document.getElementById("option35").checked = false;
    document.getElementById("option36").checked = false;
    document.getElementById("option37").checked = false;
    document.getElementById("option38").checked = false;
}

function checkFourth() {
    var result4 = document.getElementById('result41').value;
    var result5 = document.getElementById('result42').value;
    var result6 = document.getElementById('result43').value;
...
function emptyFourth() {
    ...
    document.getElementById('result41').value = '';
    document.getElementById('result42').value = '';
    document.getElementById('result43').value = '';
}

function checkFifth() {
    var result7 = document.getElementById('result51').value;
    var result8 = document.getElementById('result52').value;
...
function emptyFifth() {
    ...
    document.getElementById('result51').value = '';
    document.getElementById('result52').value = '';
}

function checkSixth() {
    var number2 = document.getElementById('number62').checked;
    var number4 = document.getElementById('number64').checked;
...
function emptySixth() {
    document.getElementById('number61').checked = false;
    document.getElementById('number62').checked = false;
    document.getElementById('number63').checked = false;
    document.getElementById('number64').checked = false;
    document.getElementById('yes/no6').innerHTML = "";
}

function checkSeventh() {

    res=document.getElementById('result71').value
    if (isNaN(res)) {
...
function emptySeventh() {
    document.getElementById('result71').value = '';
...
function emptyEighth() {
    for (let i = 81; i <= 84; i++) { // i nedrikst but lielaks par pareizo atbilzu skaitu! //input
        let placeholder;
        try {
...
function checkTenth() {
    var number2 = document.getElementById('number102').checked;
    var number3 = document.getElementById('number103').checked;
    var number5 = document.getElementById('number105').checked;
...
function emptyTenth() {
    document.getElementById('number101').checked = false;
    document.getElementById('number102').checked = false;
    document.getElementById('number103').checked = false;
    document.getElementById('number104').checked = false;
    document.getElementById('number105').checked = false;
    document.getElementById('yes/no10').innerHTML = "";
}

function checkEleventh(){

    res=document.getElementById("result111").value
    if (!isNaN(res)) {
...
function emptyEleventh() {
    document.getElementById('result111').value = '';
